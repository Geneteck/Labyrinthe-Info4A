...
class Labyrinthe
{
        ...
        int getS();             // Retourne la valeur du d'indice actuelle s dans la pile
        int pop();              // Renvoie le dernier indice concaténer dans la pile 
        void push(int id);      // Envoie dans la pile d'indice id à la case d'indice s
        ...
        int getNbColonnes(); //Retourne le nombre de colonnes de la grille.
        int getTaille(); // Retourne le nombre de cases de la grille
